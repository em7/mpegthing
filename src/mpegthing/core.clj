...
(defn characters-as-strings
  "Returns the characters (letters) as strings from the input string.
  E.g. for input \"a     cb\" returns (\"a\" \"c\" \"b\")"
  [s]
  (re-seq #"[a-zA-Z]" s))
...
(defn user-entered-valid-move
  "Handles the next step after the user has entered a valid move."
  [board]
  (if (can-move? board)
    (prompt-move board)
    (game-over board)))
